/* 
* @Author: Jennica
* @Date:   2015-03-01 12:32:12
* @Last Modified by:   Jennica
* @Last Modified time: 2015-03-01 15:05:28
*/
...
function slider(container, nav){
    ...
    this.imgs = this.container.find('.image-carousel'); // Returns jQuery object containing all matched elements.
